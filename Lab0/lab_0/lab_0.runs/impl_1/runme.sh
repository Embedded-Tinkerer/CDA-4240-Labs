...
HD_PWD='K:/My Drive/Grad/FAU_PhD/CDA 4240 - Design of Digital Systems/Labs/Lab0/lab_0/lab_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mydesign1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mydesign1.tcl -notrace
