...
HD_PWD='K:/My Drive/Grad/FAU_PhD/CDA 4240 - Design of Digital Systems/Labs/Lab0/lab_0/lab_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mydesign1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mydesign1.tcl
