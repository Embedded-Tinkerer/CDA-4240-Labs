...
HD_PWD='K:/My Drive/Grad/FAU_PhD/CDA 4240 - Design of Digital Systems/Labs/Lab1/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_top.tcl -notrace
