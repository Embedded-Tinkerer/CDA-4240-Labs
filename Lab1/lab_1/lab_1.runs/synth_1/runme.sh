...
HD_PWD='K:/My Drive/Grad/FAU_PhD/CDA 4240 - Design of Digital Systems/Labs/Lab1/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_top.tcl
